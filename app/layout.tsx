...
export const metadata: Metadata = {
    title: 'Portfolio - Abhipsa Bose',
    description:
        'Personal portfolio of Abhipsa Bose, a Flutter developer and AI/ML enthusiast specializing in building intelligent, cross-platform applications.',
};
